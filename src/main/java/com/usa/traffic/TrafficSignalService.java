...
/*	public void startSignaling(int greenSignalDuration, int numOfSeconds) {
		...
		int redSignalHalfCycle = greenSignalDuration + 1;
		...
		for (int i = 0; i <= numOfSeconds; i++) {
			...
			else if ((i > redSignalHalfCycle - greenSignalDuration && i < redSignalHalfCycle) || i == 1)
				snellRdVehiclesCount--;
			else if (i > redSignalHalfCycle + 1)
